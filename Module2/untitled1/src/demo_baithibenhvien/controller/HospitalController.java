package demo_baithibenhvien.controller;

import demo_baithibenhvien.servicer.HospotalServicelImpl;

import java.util.Scanner;

public class HospitalController {
    public void displayHospotalMenu() {
        HospotalServicelImpl hospotalServicel = new HospotalServicelImpl();
