...
public class DoctorRepository {
    ...
    private static final String fileNameDoctor = "E:\\CodeGym\\A0223I1-NguyenXuanBao\\Module2\\untitled1\\src\\demo_baithibenhvien\\data\\doctor.csv";
                ...
                try {
                    if (splitData.length >= 7) {
                        ...
                        if (!stId.equals("ID")){
                            ...
                            int sdt = Integer.parseInt(splitData[3]);
