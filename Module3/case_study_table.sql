use case_study;
insert into nhan_vien values (2, 'Lê Văn Bình', "1997-04-09", 654231234, 7000000, 0934212314, 'binhlv@gmail.com', '22 Yên Bái, Đà Nẵng', 1, 3, 1);
insert into nhan_vien values (3, 'Hồ Thị Yên', "1995-12-12", 999231723, 14000000, 0412352315, 'thiyen@gmail.com', 'K234/11 Điện Biên Phủ, Gia Lai', 1, 3, 2),
...
insert into khach_hang values (1, 5, 'Nguyễn Thị Đào', "1970-11-07", b'0',  643431213, 0945423362, 'thihao07@gmail.com', '23 Nguyễn Hoàng, Đà Nẵng'),
...
insert into dich_vu values (1, 'Karaoke', 500, 10000, 5, 1, 1, 'tien nghi,hien dai', 'co ho boi', 500, 4);
insert into dich_vu values	(2, 'Thuê xe máy', null, 10000, 5, 2, 2, 'hỏng 1 xe', 'Có thêm bếp nướng', null, 3);
insert into dich_vu values(3, 'Thuê xe đạp', null, 20000, 5, 4, 3, 'tốt', 'Có tivi', null, null);
insert into dich_vu values(4, 'Buffet buổi sáng', 300, 15000, 5, 3, 1, 'đầy đủ đồ ăn, tráng miệng', 'Có hồ bơi', 300, 3);
insert into dich_vu values(5, 'Buffet buổi trưa', null, 90000, 5, 3, 2, 'đầy đủ đồ ăn, tráng miệng', 'Có thêm bếp nướng', null, 2);
insert into dich_vu values(6, 'Buffet buổi tối', null, 16000, 5, 4, 3, 'đầy đủ đồ ăn, tráng miệng', 'Có tivi', null, null);
