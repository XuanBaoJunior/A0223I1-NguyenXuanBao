...
VALUES ('P001', 'Product 1', 10.99, 100, 'Description 1', 1),
...
DELIMITER
//
CREATE PROCEDURE AddNewProduct(IN code VARCHAR (10), IN name VARCHAR (50), IN price DECIMAL (10, 2), IN amount INT,
                               IN description TEXT, IN status BOOLEAN)
BEGIN
INSERT INTO Products (productCode, productName, productPrice, productAmount, productDescription, productStatus)
