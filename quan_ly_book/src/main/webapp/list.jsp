...
<table class="table table-bordered">
    ...
    <c:forEach var="theMuonSach" items="${theMuonSachList}">
        <tr>
            ...
            <td><button><a href="/TheMuonSachServlet?action=update&id=${theMuonSach.ma_muon}&bookid=${theMuonSach.book.id_book}&studentid=${theMuonSach.student.id_student}"  class="btn btn-primary">Mượn</a></button></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
