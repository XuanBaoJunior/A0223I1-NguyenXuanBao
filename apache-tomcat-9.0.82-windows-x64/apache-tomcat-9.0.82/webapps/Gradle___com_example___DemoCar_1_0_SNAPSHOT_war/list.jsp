...
<table class="table table-hover">
    ...
    <tbody>
    <c:forEach items="${list}" var="loaixe" varStatus="loop">
        <tr>
            <td><c:out value="${loop.count}"/></td>
            <td><c:out value="${loaixe.getName()}"/></td>
            <td><c:out value="${loaixe.getGia_xe()}"/></td>
            <td><c:out value="${loaixe.getNam_san_xuat()}"/></td>
            <td><c:out value="${loaixe.getColor()}"/></td>
            <td><c:out value="${loaixe.getSan_xuat().getNuoc_san_xuat()}"/></td>
            <td>
                <a href="/LoaiXeServlet?action=showEdit&id=${loaixe.getId_loai_xe()}&category_id=${loaixe.getSan_xuat().getId()}"
                   class="btn btn-outline-primary"
                   role="button">EDIT</a> |
                <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
                        data-bs-target="#exampleModal"
                        onclick="Click('${loaixe.getId_loai_xe()}', '${loaixe.getName()}')">
                    DELETE
                </button>
            </td>
        </tr>
